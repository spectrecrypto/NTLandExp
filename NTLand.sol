...
contract NTLandDeploy is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    // This is the function we call to determine rarities
    // By commenting out the require line we can access unminted Land Deeds
    // Note: This is the one and only change we make to the contract
